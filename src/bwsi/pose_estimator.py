...
class PoseEstimator:
    ...
    def clicked_pose(self, msg):
        ...
        self.particles[:,2] = quaternion_to_angle(pose.orientation) + self.normal(.4)
    ...
    def sample_motion_model(self, u):
        ...
        rot1_samples = delta_rot1 -  np.random.normal(0.,dev1,self.num_particles)
        trans_samples = delta_trans -  np.random.normal(0.,dev2, self.num_particles)
        rot2_samples = delta_rot2 - np.random.normal(0., dev3, self.num_particles)
